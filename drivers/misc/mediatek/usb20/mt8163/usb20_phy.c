...
#ifdef CONFIG_Z300M
extern int Read_SLIMPORT_ID(void);
#endif
...
#ifdef CONFIG_Z300M
	if(Read_SLIMPORT_ID()){
		printk("Before set 0x15=0x%x\n", USBPHY_READ8(0x15));
		value = USBPHY_READ8(0x15);
		USBPHY_CLR8(0x15, 0x70);
		USBPHY_WRITE8(0x15, value + (0x2 <<4));
		printk("After set 0x15=0x%x\n", USBPHY_READ8(0x15));
	}
#endif

	/* adjust VRT_VREF_SEL to 820mv, adjust TERM_VREF_SEL to 480mv */
	USBPHY_SET8(0x05, 0x77);
