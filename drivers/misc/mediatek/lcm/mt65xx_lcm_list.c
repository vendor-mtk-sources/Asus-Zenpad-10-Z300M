...
#if defined(Z380M_CPT_ILI6136S)
	&z380m_cpt_ili6136s_lcm_drv,
#endif

#if defined(Z380M_KD_RM68200G01)
	&z380m_kd_rm68200g01_lcm_drv,
#endif

#if defined(Z380M_AUO_RM72014)
	&z380m_auo_rm72014_lcm_drv,
#endif

#if defined(Z380M_AUO_RM68200)
	&z380m_auo_rm68200_lcm_drv,
#endif

#if defined(Z300M_CPT_NT35521S)
	&z300m_cpt_nt35521s_lcm_drv,
#endif

#if defined(Z300M_BOE_NT35521S)
	&z300m_boe_nt35521s_lcm_drv,
#endif

#if defined(Z300M_KD_OTM1287A)
	&z300m_kd_otm1287a_lcm_drv,
#endif
