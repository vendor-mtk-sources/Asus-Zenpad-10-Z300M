...
//#define KD_LCM_ID0 0x0
//#define KD_LCM_ID1 0x0
...
int kd_lcm_vgp_supply_enable(void)
{
	int ret;
	unsigned int volt;
...
int kd_lcm_vgp_supply_disable(void)
{
	int ret = 0;
...
LCM_DRIVER z380m_kd_rm68200g01_lcm_drv = {
	.name = "z380m_kd_rm68200g01",
...
static int __init lcm_init(void)
{
	...
	if (!strcmp(z380m_kd_rm68200g01_lcm_drv.name, lk_lcmname)) {
