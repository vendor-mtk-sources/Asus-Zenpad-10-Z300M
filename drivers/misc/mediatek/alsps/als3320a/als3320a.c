...
#define CALIBRATION_LIMIT	1	// use calibration limit
...
#define ALS3320A_GOLDEN_VALUE_Z300M	250 // 480 for SR , 250 for ER
...
#ifdef CALIBRATION_LIMIT
static int calibration_high_limit = 1000;
static int calibration_low_limit = 20;
#endif
...
#ifdef CALIBRATION_LIMIT
	if( (als3320a_cali.als_cali_lux<calibration_high_limit) && (als3320a_cali.als_cali_lux>calibration_low_limit) )
		ret = als3320a_write_to_califile(als3320a_cali.als_cali_base, als3320a_cali.als_cali_lux);
	else{
		ret = 0;
		if(als3320a_openlog) APS_LOG("calibration out of range (%d) !!\n", als3320a_cali.als_cali_lux);
	}
#else
	ret = als3320a_write_to_califile(als3320a_cali.als_cali_base, als3320a_cali.als_cali_lux);
#endif
